...
void initUI() {
    ...
    dropSkin = sf::Text("Zmien Skorke", font, 18); dropSkin.setPosition(15.0f, TOP_UI_HEIGHT + 40.0f);
    dropFullscreen = sf::Text("Pelny Ekran (F11)", font, 18); dropFullscreen.setPosition(15.0f, TOP_UI_HEIGHT + 70.0f);
    dropMenu = sf::Text("Wroc do Menu", font, 18); dropMenu.setPosition(15.0f, TOP_UI_HEIGHT + 100.0f);
    
    dropdownBg.setSize(sf::Vector2f(200.0f, 130.0f));
